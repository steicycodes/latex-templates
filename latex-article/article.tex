...
\title{The Effect of the Educational Voucher System Policy in Arkansas}
\author{
  Steicy Lopez\\ {\itshape\large University of Chicago}
}
\date{\today}

\hypersetup{
  pdftitle = {The Effect of the Educational Voucher System Policy in Arkansas},
  pdfauthor = {Steicy Lopez},
}
...
I'll show off these things, but make sure to check the source code alongside to see how simple it is to typeset with this. 
\kyle{I'm including this comment for coauthors. If I switch above to \texttt{togglefalse}, this will disappear.}
...
For tables, I use the \texttt{tabular} and \texttt{booktabs} packages. For table and figure notes, I use a custom \texttt{\textbackslash note} command. It uses \texttt{\textbackslash parbox} under the hood. You can use it in one of four ways:
\begin{enumerate}
